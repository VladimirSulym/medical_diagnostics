...
from users.models import User, Doctor, Department, Specialization, PatientQuestionnaire
...
class DoctorAdmin(admin.ModelAdmin):
    list_display = ("user", "specialization", "department", "experience", "category", "rating")
...
class PatientQuestionnaireAdmin(admin.ModelAdmin):
    list_display = ("user", "user__first_name", "user__last_name")
    search_fields = ("user__email", "user__first_name", "user__last_name")
